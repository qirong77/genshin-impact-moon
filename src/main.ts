...
galaxyFolder.add(galaxyGroup.rotation, 'x', 0, Math.PI * 2).name('X轴旋转')
galaxyFolder.add(galaxyGroup.rotation, 'y', 0, Math.PI * 2).name('Y轴旋转')
galaxyFolder.add(galaxyGroup.rotation, 'z', 0, Math.PI * 2).name('Z轴旋转')
galaxyFolder.open()
